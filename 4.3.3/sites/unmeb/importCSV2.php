...
define( 'iHRIS_START_DATE', 1);
define( 'iHRIS_END_DATE', 2);
...
while ( ( $data = fgetcsv( $fh ) ) !== false ) {
	...
	if ( $data[iHRIS_TRAINING] != ""){
		$training_id = find_or_create( ("Butabika School Of Psychiatric Nursing - ".ucwords(strtolower($data[iHRIS_TRAINING]))." - Butabika (".$data[iHRIS_START_DATE]." - ".$data[iHRIS_END_DATE].")"), "provider_instance");
