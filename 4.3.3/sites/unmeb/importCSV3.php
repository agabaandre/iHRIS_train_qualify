...
while ( ( $data = fgetcsv( $fh ) ) !== false ) {
    ...
    $row++;
	if ( !$training_id = find_or_create (($data[iHRIS_TRAINING_SCHOOL]." - ".ucwords(strtolower($data[iHRIS_TRAINING]))." - ".$data[iHRIS_TRAINING_SCHOOL]." (".$data[iHRIS_START_DATE]." - ".$data[iHRIS_END_DATE].")"), "provider_instance",false ,false ,true )){
        echo "Row $row: Provide Instance is invalid: '" .($data[iHRIS_TRAINING_SCHOOL])." - ".ucwords(strtolower($data[iHRIS_TRAINING]))." - ".($data[iHRIS_TRAINING_SCHOOL])." (".$data[iHRIS_START_DATE]." - ".$data[iHRIS_END_DATE].") \n";
        $errors++;
    }/*
...
while ( ( $data = fgetcsv( $fh ) ) !== false ) {
   ...
   */
	...
	if ( $data[iHRIS_TRAINING] != ""){
		$training_id = find_or_create( (($data[iHRIS_TRAINING_SCHOOL])." - ".ucwords(strtolower($data[iHRIS_TRAINING]))." - ".($data[iHRIS_TRAINING_SCHOOL])." (".$data[iHRIS_START_DATE]." - ".$data[iHRIS_END_DATE].")"), "provider_instance");
