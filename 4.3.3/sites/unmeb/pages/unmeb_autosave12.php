...
foreach ($person_ids as $id) {
    ...
    if(count($person->children['person_instance']) > 0){
        ...
        foreach( $person->children['person_instance'] as $person_instance ) {
            ...
            if ($provider_instance->getField('academic_year')->getDBValue() == 'academic_year|year_1' || $provider_instance->getField('academic_year')->getDBValue() == 'academic_year|3' || $provider_instance->getField('academic_year')->getDBValue() == 'academic_year|4') {
