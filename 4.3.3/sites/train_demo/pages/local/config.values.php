 ...
 */
$i2ce_site_i2ce_path = "/var/lib/iHRIS/releases/4.3.3/i2ce";


/**
 * the dsn to connect to your databse
 */
$i2ce_site_dsn = 'mysql://ihris:ihris@2022systems@172.27.1.230/iHRIS_train_demo' ;
 ...
 */
$i2ce_site_module_config = "/var/lib/iHRIS/releases/4.3.3/sites/train_demo/Uganda-Train-MoH.xml";
