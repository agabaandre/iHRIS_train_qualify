 ...
 * @access public
 */
class iHRIS_PageFormParentTrainingProvider extends I2CE_PageForm {
    ...
    protected function loadObjects() {
        if ($this->isPost()) {
            ...
            if (strpos($parent,'|')=== false) {
                ...
                $parent =  'trainingprovider|' . $parent;            
            }
        ...
        if (!$person instanceof iHRIS_TrainingProvider) {
    ...
    protected function loadHTMLTemplates() {
        ...
        $this->template->appendFileById( "menu_view_tp_link.html", "li", "navBarUL", true );
        $this->template->appendFileById( "form_" . $this->getForm( true ) . ".html", "tbody", "trainingprovider_form" );
    }
    ...
    protected function setDisplayData() {
        ...
        $this->template->setDisplayData( "trainingprovider_header", $this->getTitle());
        $this->template->setDisplayData( "trainingprovider_form", $this->form_link);
    }
