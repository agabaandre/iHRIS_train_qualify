...
class iHRIS_Module_Qualify extends I2CE_Module {
    ...
    public function upgrade($old_vers,$new_vers) {
        if (I2CE_Validate::checkVersion($old_vers,'<','3.0.1000')) {
            I2CE::raiseError("Upgrading from versions previous to 3.0.1 is currently deprecated.  Please contact ihris@googlegroups.com if you need to perform this upgrade.");
            die();
            /* Removed because it's probably no longer needed and it was using old MDB2 code.
